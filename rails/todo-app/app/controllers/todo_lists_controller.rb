class TodoListsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @todo_list.update(todo_list_params)
        format.html { redirect_to todo_list_url(@todo_list), notice: "Lista atualizada com sucesso
        !" }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to todo_lists_url, notice: "Lista excluída com sucesso" }
